...
ws <-
    ...
    mutate(ws_100 = ifelse(ws_100 < 1, NA, ws_100)) 
...
# Fill AGAIN ws_120 in function of ws_100 (already completed with ws_060 )
...
# ws_bc_100_rec <-
#     recipe(ws_060_bc ~ ., data = ws_bc) |>
#     step_impute_linear(ws_100_bc, impute_with = imp_vars(ws_120_bc))

# ws_bc_100_imputed <- ws_bc_100_rec |> prep() |> bake(new_data = NULL)
